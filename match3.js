...
Match3 = function()
{
    ...
    var swap = function(square1, square2, checkForMatches)
    {
        ...
        // Apply the swap
        square1.moveTo(square2Position.x, square2Position.y, 600);
        square2.moveTo(square1Position.x, square1Position.y, 600);
        square1.moving = true;
        square2.moving = true;
    ...
    var update = function()
    {
        ...
        if(check.length <= 0) // No blocks need checking
        {
            if(!wholeBoardCheck)
            {
                ...
                if(!validMoves())
                {
                    var sprite = new TextSprite("NO MOVES LEFT!",self.cellSize.x/1.5 + 'px PT_Sans-Bold', '#ff5613', 'center', self.topLayer);
    ...
    var pointsPopup = function(position, score)
    {
        ...
        var text = new TextSprite(score,self.cellSize.x/2.4 + 'px PT_Sans-Bold', '#ff5613', 'center', self.topLayer);
